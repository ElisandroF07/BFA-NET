        ...
        <div className="payments_container">
            <div className="payments_header">
                ...
                <div className='bottom'>
                    <div><h2>Saldo contabilístico</h2><p>Kz 832.540,00</p></div>
                    <div><h2>Saldo autorizado</h2><p>Kz 832.540,00</p></div>
                    <div><h2>Selecione o tipo de pagamento</h2>
                        <select name="payment_type" id="payment_type" onChange={(event)=>setSelectedPage(event.target.value)}>
            ...
            <div className="payments_lateral"></div>
        </div>
    )
}