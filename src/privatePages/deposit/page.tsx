  ...
  return(
    ...
    <div className="payments_body">
     ...
     <div className="cardDeposit">
      ...
      <div className="actionButtons"><Link target="_blank" href="https://www.bfa.ao/media/4249/ficha-tecnica-informativa-dp-bfa-10.pdf">Ficha técninca</Link> <button>Constituir</button></div>
     </div>
     <div className="cardDeposit">
      <h2>DP BFA 13%</h2>
      ...
      <div className="actionButtons"><Link target="_blank" href="https://www.bfa.ao/media/4250/ficha-tecnica-informativa-dp-bfa-13.pdf">Ficha técninca</Link> <button>Constituir</button></div>
     </div>
     <div className="cardDeposit">
      ...
      <div className="actionButtons"><Link target="_blank" href="https://www.bfa.ao/media/5506/ficha-te-cnica-informativa-dp-especial-crescente.pdf">Ficha técninca</Link> <button>Constituir</button></div>
     </div>
     </div>
