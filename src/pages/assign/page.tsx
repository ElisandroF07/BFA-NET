...
export default function Assign() {
	...
	function uploadSelfie(): Promise<string> {
		...
		return new Promise(async (resolve, reject) => {
			try {
				const response = await axios.post(`https://environmental-kristina-franco07-98c1a6b0.koyeb.app//upload/${email ?? useStore.email}/4`, formData,{ headers: { "Content-Type": "multipart/form-data" } },);
