    ...
    <main className="privateMainContainer">
      ...
      <section className="privateChildrenContainer">
          {page === "Dashboard" ? (
            ...
            <Consults authorized_balance={useAccount.authorized_balance} available_balance={useAccount.available_balance} iban={useAccount.iban} />
          ) : page === "Levantamentos" ? (
            <Upmoney authorized_balance={useAccount.authorized_balance} available_balance={useAccount.available_balance} email={email}/>
          ) : page === "Transferências" ? (
            <Transfers authorized_balance={useAccount.authorized_balance} available_balance={useAccount.available_balance} iban={useAccount.iban} number={useAccount.number}/>
          ) : null}
      </section>
    </main>
  )
