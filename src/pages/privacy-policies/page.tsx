...
import business from "@/assets/images/Privacy policy-bro.svg";
						...
						<div className="body_form">
							<div className="privacy_container">
								...
								<p>
									...
									conceitos de literacia financeira junto do público mais jovens
									e com idades maior de 14 anos. Toda a informação
									disponibilizada tem como objectivo o conhecimento geral e
									partilha de conhecimento quanto a Literacia Financeira, sendo
									abordada de uma forma acessível e não substitui de forma
									alguma o conselho e o recurso a especialistas em caso de
									necessidade. O Banco de Fomento Angola construiu a app BFA
									Educar como uma app gratuita. Este SERVIÇO é fornecido pelo
									Banco de Fomento Angola sem qualquer custo e destina-se a ser
									utilizado tal como está. Esta página é usada para informar os
									...
									conforme descrito nesta Política de Privacidade. Os termos
									utilizados nesta Política de Privacidade têm os mesmos
									significados que os nossos Termos e Condições, acessíveis no
									BFA Educar, salvo disposição em contrário nesta Política de
									Privacidade.
								</p>
								...
								<p>
									...
									pessoal, um nome(nickname) e e-mail. As informações que
									...
									identificá-lo. Link para a política de privacidade de
									provedores de serviços terceirizados usados pelo app: •
									Serviços do Google Play
								</p>
								<h1>Dados de registo</h1>
								<p>
									Queremos informar que sempre que usar o nosso Serviço, em caso
									de erro no aplicativo, colectamos dados e informações (através
									de produtos de terceiros) em seu telefone chamado Log Data.
									Esses dados de registo podem incluir informações como endereço
									de protocolo de Internet (IP) do dispositivo, nome do
								...
								<p>
									...
									são comumente usados como identificadores únicos anónimos.
									Estes são enviados para o seu navegador a partir dos sites que
									você visita e são armazenados na memória interna do seu
									dispositivo. <br />
									Este Serviço não usa esses “cookies” explicitamente. No
									entanto, o aplicativo pode usar código e bibliotecas de
									terceiros que usam “cookies” para colectar informações e
									melhorar seus serviços. Tem a opção de aceitar ou recusar
									esses cookies e saber quando um cookie está sendo enviado ao
									seu dispositivo. Se você optar por recusar nossos cookies,
								...
								<p>
									...
									aos seguintes motivos: • Para facilitar nosso Serviço <br /> •
								...
								<p>
									...
									podemos garantir sua segurança absoluta. Implementamos medidas
									de segurança adequadas para proteger as informações pessoais
									das crianças contra perda, uso indevido, acesso não
									autorizado, divulgação, alteração ou destruição não
									autorizada. Essas medidas incluem, mas não se limitam a
									controles de acesso físico e electrónico, criptografia de
									dados e treinamento de funcionários.
								</p>
								<h1>Privacidade das crianças</h1>
								<p>
									Esses Serviços não se destinam a menores de 14 anos. Não
									colectamos intencionalmente informações de identificação
									pessoal de crianças menores. No caso de descobrirmos que uma
									criança menor de 14 anos nos forneceu informações pessoais,
									...
									leis aplicáveis. Informações agregadas não identificáveis (
									nickname+ email dos pais) que não permitem a identificação
									pessoal da criança. As informações pessoais que podemos
									colectar incluem, unicamente: <br /> • Nick Name <br /> •
									Endereço de e-mail do pai, mãe ou responsável legal; <br />{" "}
									Não compartilhamos informações pessoais de crianças com
									terceiros, excepto nas seguintes circunstâncias: • Se
									obtivermos o consentimento dos pais ou responsáveis legais; •
									Quando necessário para cumprir uma obrigação legal, como
									responder a uma ordem judicial ou processo legal; • Para
									proteger os direitos, propriedade ou segurança de nossa
									empresa, usuários da aplicação ou o público em geral. •
								...
								<p>
									...
									Privacidade nesta página. <br /> Esta política é efectiva a
									partir de 2023-06-13
								</p>
								<h1>Contacte-nos</h1>
								<p>
									Todos os dados, marcas registadas e todo o conteúdo em geral
									constante da APP BFA EDUCAR são da propriedade do Banco de
									Fomento Angola ou de alguma empresa sua parceira e estão
									protegidas nos termos gerais do direito, pela legislação
									nacional e internacional de protecção da Propriedade
									Intelectual Se tiver alguma dúvida ou sugestão sobre a nossa
									Política de Privacidade, não hesite em contactar-nos para{" "}
									<Link
							...
							<div className="terms">
								<p>
									...
									<Link
										rel="external"
										target="_blank"
										href="https://www.bfa.ao/media/4985/politica-de-privacidade-bfa-educar.pdf"
									>
